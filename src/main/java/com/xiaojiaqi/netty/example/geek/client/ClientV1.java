...
public class ClientV1 {
    public static void main(String[] args) throws Exception {
        ...
        RequestMessage requestMessage = new RequestMessage(IdUtil.nextId(), new OrderOperation(1002, "tudou"));

        OrderOperation tudou = new OrderOperation(1003, "tudou");

        future.channel().writeAndFlush(tudou);
